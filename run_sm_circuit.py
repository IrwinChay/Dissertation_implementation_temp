...
# from cirkit.layers.input.sm_layer_imag_flatten import SMKernelPosImagLayer, SMKernelNegImagLayer, SMKernelImagFlattenLayerParams
from cirkit.layers.input.sm_layer_imag import SMKernelImagLayerParams
...
def main():
    ...
    for run in range(1, 4):  # Running the model 3 times
        ...
        params_module = SMKernelImagLayerParams(num_vars=num_vars, num_output_units=num_mixtures)
