...
class SMKernelLayer(InputLayer):
    ...
    def forward(self, x1: Tensor, x2: Tensor) -> Tensor:
        ...
        x1_exp = x1_ * self.params_sigma()
        x2_exp = x2_ * self.params_sigma()
        x1_cos = x1_ * self.params_mu()
        x2_cos = x2_ * self.params_mu()
        ...
        return res.permute(1, 2, 3, 0).unsqueeze(-1)
