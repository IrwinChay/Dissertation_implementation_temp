...
from cirkit.layers.sum_product.cp_w_bias_flatten import CPLayerWithBias
from cirkit.layers.input.rbf_network_kernel_flatten import RBFNetworkKernelFlattenLayer
...
efamily_cls = RBFNetworkKernelFlattenLayer   # Flatten
...
def main():
    ...
    for num_mixtures in num_mixtures_s:
        ...
        for run in range(1, 4):  # Running the model 5 times
